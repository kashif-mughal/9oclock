      ...
      <div class="col-xl-12 col-lg-12 col-md-12">
         <div class="featured-products panel-min-height">
            <div class="header">
               ...
               <div class="lds-roller" style="position:absolute; top:45%;right:45%;">
                  <div></div>
                  <div></div>
                  <div></div>
                  <div></div>
            ...
            <div class="slider featured-product-slider">
               <?php foreach ($ProdList as $value)
                  {
                      if ($value['IsFeatured'] != 1) continue;
               ...
               <div class="featured-products-content d-flex align-items-center justify-content-start">
                  <div class="card mr-2 each-prod product-card-inner" style="padding-top:5px; padding-bottom: 10px; height: unset !important;">
                     <div class="card-body p-0">
                        <?php if (empty($value['QuantityAvailable']) || $value['QuantityAvailable'] < 1)
                           {
                     ...
                     <div class="d-flex align-items-center justify-content-center">
                        <?php if ($value['stock'] == '1')
                           { ?>
                        <a href="javascript:void(0);" class="product-card-btn 
                           <?php if (!empty($value['QuantityAvailable']) && $value['QuantityAvailable'] > 0)
                              {
                                  echo " add-cart";
                              }
                              else
                           ...
                           <?php if (!empty($value['QuantityAvailable']) && $value['QuantityAvailable'] > 0)
                              {
                                  echo " data-json='" . htmlentities(json_encode($productObject) , ENT_QUOTES, 'UTF-8') . "'";
                              } ?>
                           >Add to Cart</a>
