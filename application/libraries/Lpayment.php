...
class Lpayment {
    ...
    public function get_payment_list() {
        ...
        $payment_list = $CI->Payment->payment_list();
        ...
        $PaymentList = $CI->parser->parse('payment/manage_payment_list', $data, true);
        return $PaymentList;
    }

    public function save_record($responseData) {
        $CI = & get_instance();
        $isInserted = $CI->Payment->save_bank_trans_log($responseData);
        return TRUE;
    }

    public function update_payment_status($data) {
        $CI = & get_instance();
        $CI->Payment->update_order_trans_status($data);
        return TRUE;
    }
